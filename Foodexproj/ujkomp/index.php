        ...
        <form method="get">
            <div class="row">
                <div class="form-group col-md-6 col-sm-12">
                    ...
                    <input id="pont" type="text" value="0" name="pont">
                    <script>
                ...
                <div class="form-group col-md-6 col-sm-12">
                    ...
                    <input id="megj" name="megj" type="text" placeholder="pl. Nem jelent meg a műszakon." value="" class="form-control">
                </div>

            </div>


            <button class="btn btn-primary pull-right" name="komp" onclick="submitKomp()" type="button">Kompenzálás
            </button>
