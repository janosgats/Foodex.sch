...
<head>
    ...
    <style>
        ...
        .button {
            background-color: var(--buttonborder) !important;
...
<div class="content-container">
    ...
    <div class="context primary-text-color" style="padding-top: 0; margin-top: 0">
        ...
        <p><br>
            ...
            Nem bug, hanem feature! Legközelebb tuti működni fog.<br>

            Ha valami mégsem lenne fasza, csak szólj!</p>
